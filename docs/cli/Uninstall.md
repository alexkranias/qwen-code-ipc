...
If you installed the CLI globally (e.g., `npm install -g qwen-code-ipc`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g qwen-code-ipc
```
